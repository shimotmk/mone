...
?>
<!-- wp:query {"queryId": 63,"query":{"perPage":4,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"rand","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false, "moneQueryType":"related-query-loop"},"namespace":"mone-related-query-loop","enhancedPagination":true} -->
...
<h4 class="wp-block-heading has-key-2-color has-text-color has-link-color" style="border-left-color:var(--wp--preset--color--key-2);border-left-width:9px;padding-right:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10);font-style:normal;font-weight:500"><?php esc_html_e( 'Related Posts', 'mone' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:post-template {"layout":{"type":"grid","columnCount":"2"}} -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|10","bottom":"var:preset|spacing|10","left":"var:preset|spacing|10","right":"var:preset|spacing|10"}},"border":{"width":"1px"},"dimensions":{"minHeight":"100%"}},"borderColor":"mone-border","layout":{"type":"default"}} -->
<div class="wp-block-group has-border-color has-mone-border-border-color" style="border-width:1px;min-height:100%;padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--10)"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"1.91/1","style":{"border":{"width":"1px"},"borderColor":"mone-border","spacing":{"padding":{"top":"0","bottom":"0"}}},"borderColor":"mone-border"} /-->
